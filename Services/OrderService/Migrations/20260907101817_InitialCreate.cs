        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_PaymentIntents_Status", "Status IN ('CREATED','PAID','FAILED','EXPIRED')");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoctorId = table.Column<int>(type: "int", nullable: false),
                    DoctorNameSnapshot = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Orders_CancelledBy", "CancelledBy IN ('ADMIN','SYSTEM')");
                    table.CheckConstraint("CK_Orders_Status", "Status IN ('NEW','VERIFIED','PICKED_UP','COMPLETED','CANCELLED')");
                    table.ForeignKey(
                        name: "FK_Orders_PaymentIntents_PaymentIntentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_DoctorId_Status",
                table: "Orders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_Status_CreatedAt_VerifiedAt",
                table: "Orders",
                columns: new[] { "Status", "CreatedAt", "VerifiedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_PaymentIntents_DoctorId",
                table: "PaymentIntents",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentIntents_RazorpayOrderId",
                table: "PaymentIntents",
